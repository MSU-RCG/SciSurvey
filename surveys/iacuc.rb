survey "IACUC Protocol", :default_mandatory => false do
	...
	q_gupoject_Title "1. Project Title:"
    a_1 :string
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h10e, "count>0"
    condition_B :q_h10e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :hfq, "count>0"
    condition_B :hfq, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h12q, "count>0"
    condition_B :q_h12q, "!=", :a_no
    q_h11a22 "does (mg/kg):"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h12q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h13q, "count>0"
    condition_B :q_h13q, "!=", :a_no
    q_h11a23 "does (mg/kg):"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h13q, "count>0"
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_h15q, "count>0"
    condition_B :q_h15q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h16q, "count>0"
    condition_B :q_h16q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_h16qe, "count>0"
    condition_B :q_h16qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h17q, "count>0"
    condition_B :q_h17q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h21q, "count>0"
    condition_B :q_h21q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h22q, "count>0"
    condition_B :q_h22q, "!=", :a_no
    q_h22c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h22q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h23q, "count>0"
    condition_B :q_h23q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_h25q, "count>0"
    condition_B :q_h25q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h26q, "count>0"
    condition_B :q_h26q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_h27q, "count>0"
    condition_B :q_h27q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb10e, "count>0"
    condition_B :q_rb10e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb12q, "count>0"
    condition_B :q_rb12q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb13q, "count>0"
    condition_B :q_rb13q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_rb15q, "count>0"
    condition_B :q_rb15q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb16q, "count>0"
    condition_B :q_rb16q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_rb16qe, "count>0"
    condition_B :q_rb16qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb17q, "count>0"
    condition_B :q_rb17q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_rb19q, "count>0"
    condition_B :q_rb19q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb21q, "count>0"
    condition_B :q_rb21q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb22q, "count>0"
    condition_B :q_rb22q, "!=", :a_no
    q_rb22c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb22q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb23q, "count>0"
    condition_B :q_rb23q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb24q, "count>0"
    condition_B :q_rb24q, "!=", :a_no
    q_rb24c2 "Exposure:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb24q, "count>0"
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_rb25q, "count>0"
    condition_B :q_rb25q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_rb26q, "count>0"
    condition_B :q_rb26q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_rb27q, "count>0"
    condition_B :q_rb27q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g10e, "count>0"
    condition_B :q_g10e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g12q, "count>0"
    condition_B :q_g12q, "!=", :a_no
    q_g11a22 "does (mg/kg):"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g12q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g13q, "count>0"
    condition_B :q_g13q, "!=", :a_no
    q_g11a23 "does (mg/kg):"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g13q, "count>0"
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_g15q, "count>0"
    condition_B :q_g15q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g16q, "count>0"
    condition_B :q_g16q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_g16qe, "count>0"
    condition_B :q_g16qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g17q, "count>0"
    condition_B :q_g17q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g21q, "count>0"
    condition_B :q_g21q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g22q, "count>0"
    condition_B :q_g22q, "!=", :a_no
    q_g22c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g22q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g23q, "count>0"
    condition_B :q_g23q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_g25q, "count>0"
    condition_B :q_g25q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_g26q, "count>0"
    condition_B :q_g26q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_g27q, "count>0"
    condition_B :q_g27q, "!=", :a_no
...
group "Sheep" do
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h110e, "count>0"
    condition_B :q_h110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h111q, "count>0"
    condition_B :q_h111q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h112q, "count>0"
    condition_B :q_h112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h113q, "count>0"
    condition_B :q_h113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_h115q, "count>0"
    condition_B :q_h115q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h116q, "count>0"
    condition_B :q_h116q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h117q, "count>0"
    condition_B :q_h117q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_h119q, "count>0"
    condition_B :q_h119q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h121q, "count>0"
    condition_B :q_h121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h122q, "count>0"
    condition_B :q_h122q, "!=", :a_no
    q_h122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h123q, "count>0"
    condition_B :q_h123q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h124q, "count>0"
    condition_B :q_h124q, "!=", :a_no
    q_h124c2 "Exposure:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h124q, "count>0"
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_h125q, "count>0"
    condition_B :q_h125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_h126q, "count>0"
    condition_B :q_h126q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_h127q, "count>0"
    condition_B :q_h127q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh110e, "count>0"
    condition_B :q_sh110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh112q, "count>0"
    condition_B :q_sh112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh113q, "count>0"
    condition_B :q_sh113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_sh115q, "count>0"
    condition_B :q_sh115q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh116q, "count>0"
    condition_B :q_sh116q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh117q, "count>0"
    condition_B :q_sh117q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh121q, "count>0"
    condition_B :q_sh121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh122q, "count>0"
    condition_B :q_sh122q, "!=", :a_no
    q_sh122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh123q, "count>0"
    condition_B :q_sh123q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_sh125q, "count>0"
    condition_B :q_sh125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_sh126q, "count>0"
    condition_B :q_sh126q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_sh127q, "count>0"
    condition_B :q_sh127q, "!=", :a_no
    ...
    group "Horse" do
    dependency :rule => "R"
    condition_R :q_application_type1, "==", :a_s8 
    q_ho11ho "1. Breed:"
    a :string
    q_ho122 "2.Age:"
    a :string
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho110e, "count>0"
    condition_B :q_ho110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho112q, "count>0"
    condition_B :q_ho112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho113q, "count>0"
    condition_B :q_ho113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_ho115q, "count>0"
    condition_B :q_ho115q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho116q, "count>0"
    condition_B :q_ho116q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho117q, "count>0"
    condition_B :q_ho117q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho121q, "count>0"
    condition_B :q_ho121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho122q, "count>0"
    condition_B :q_ho122q, "!=", :a_no
    q_ho122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho123q, "count>0"
    condition_B :q_ho123q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_ho125q, "count>0"
    condition_B :q_ho125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ho126q, "count>0"
    condition_B :q_ho126q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_ho127q, "count>0"
    condition_B :q_ho127q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr110e, "count>0"
    condition_B :q_pr110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr112q, "count>0"
    condition_B :q_pr112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr113q, "count>0"
    condition_B :q_pr113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_pr115q, "count>0"
    condition_B :q_pr115q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr116q, "count>0"
    condition_B :q_pr116q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr117q, "count>0"
    condition_B :q_pr117q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr121q, "count>0"
    condition_B :q_pr121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr122q, "count>0"
    condition_B :q_pr122q, "!=", :a_no
    q_pr122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr123q, "count>0"
    condition_B :q_pr123q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_pr125q, "count>0"
    condition_B :q_pr125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr126q, "count>0"
    condition_B :q_pr126q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr110e, "count>0"
    condition_B :q_agr110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr112q, "count>0"
    condition_B :q_agr112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr113q, "count>0"
    condition_B :q_agr113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_agr115q, "count>0"
    condition_B :q_agr115q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr116q, "count>0"
    condition_B :q_agr116q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr117q, "count>0"
    condition_B :q_agr117q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr121q, "count>0"
    condition_B :q_agr121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr122q, "count>0"
    condition_B :q_agr122q, "!=", :a_no
    q_agr122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr123q, "count>0"
    condition_B :q_agr123q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_agr125q, "count>0"
    condition_B :q_agr125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_agr126q, "count>0"
    condition_B :q_agr126q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr1e10e, "count>0"
    condition_B :q_pr1e10e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr112eq, "count>0"
    condition_B :q_pr112eq, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr113eq, "count>0"
    condition_B :q_pr113eq, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_pr115qe, "count>0"
    condition_B :q_pr115qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr116qt, "count>0"
    condition_B :q_pr116qt, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr117qe, "count>0"
    condition_B :q_pr117qe, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_pr118qe, "count>0"
    condition_B :q_pr118qe, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_pr120qe, "count>0"
    condition_B :q_pr120qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr121qt, "count>0"
    condition_B :q_pr121qt, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr122qe, "count>0"
    condition_B :q_pr122qe, "!=", :a_no
    q_pr122c3e "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr122qe, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr123qe, "count>0"
    condition_B :q_pr123qe, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_pr125qe, "count>0"
    condition_B :q_pr125qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_pr126qe, "count>0"
    condition_B :q_pr126qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf110e, "count>0"
    condition_B :q_lhf110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf112q, "count>0"
    condition_B :q_lhf112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf113q, "count>0"
    condition_B :q_lhf113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_lhf118q, "count>0"
    condition_B :q_lhf118q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf121q, "count>0"
    condition_B :q_lhf121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf122q, "count>0"
    condition_B :q_lhf122q, "!=", :a_no
    q_lhf122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf123qe, "count>0"
    condition_B :q_lhf123qe, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_lhf125q, "count>0"
    condition_B :q_lhf125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf126q, "count>0"
    condition_B :q_lhf126q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_lhf127qee, "count>0"
    condition_B :q_lhf127qee, "!=", :a_no
    q_agr12e7iei "i. Who will perform the phyical method of euthanasia?"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_ag127qb, "count>0"
    condition_B :q_ag127qb, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf122qe, "count>0"
    condition_B :q_lhf122qe, "!=", :a_no
    q_lhf12ec3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf122qe, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf123q, "count>0"
    condition_B :q_lhf123q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_lhf125qe, "count>0"
    condition_B :q_lhf125qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_lhf126qe, "count>0"
    condition_B :q_lhf126qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup110e, "count>0"
    condition_B :q_gup110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup112q, "count>0"
    condition_B :q_gup112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup113q, "count>0"
    condition_B :q_gup113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_gup16q, "count>0"
    condition_B :q_gup16q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup17q, "count>0"
    condition_B :q_gup17q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_gup17qe, "count>0"
    condition_B :q_gup17qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup18q, "count>0"
    condition_B :q_gup18q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_gup19q, "count>0"
    condition_B :q_gup19q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_gup20q, "count>0"
    condition_B :q_gup20q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup121q, "count>0"
    condition_B :q_gup121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup122q, "count>0"
    condition_B :q_gup122q, "!=", :a_no
    q_gup122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup123qe, "count>0"
    condition_B :q_gup123qe, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_gup125q, "count>0"
    condition_B :q_gup125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_gup126q, "count>0"
    condition_B :q_gup126q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_gup127qee, "count>0"
    condition_B :q_gup127qee, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer110e, "count>0"
    condition_B :q_fer110e, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer112q, "count>0"
    condition_B :q_fer112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer113q, "count>0"
    condition_B :q_fer113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_fer16q, "count>0"
    condition_B :q_fer16q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer17q, "count>0"
    condition_B :q_fer17q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_fer17qe, "count>0"
    condition_B :q_fer17qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer18q, "count>0"
    condition_B :q_fer18q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_fer19q, "count>0"
    condition_B :q_fer19q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_fer20q, "count>0"
    condition_B :q_fer20q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer121q, "count>0"
    condition_B :q_fer121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer122q, "count>0"
    condition_B :q_fer122q, "!=", :a_no
    q_fer122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer123qe, "count>0"
    condition_B :q_fer123qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer124q, "count>0"
    condition_B :q_fer124q, "!=", :a_no
    q_fer124c2 "Exposure:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer124q, "count>0"
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_fer125q, "count>0"
    condition_B :q_fer125q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_fer126q, "count>0"
    condition_B :q_fer126q, "!=", :a_no
    ...
    a_no "No"
    dependency :rule=>"A and B"
    condition_A :q_fer127qee, "count>0"
    condition_B :q_fer127qee, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat112q, "count>0"
    condition_B :q_cat112q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat113q, "count>0"
    condition_B :q_cat113q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_cat16q, "count>0"
    condition_B :q_cat16q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat17q, "count>0"
    condition_B :q_cat17q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_cat17qe, "count>0"
    condition_B :q_cat17qe, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat18q, "count>0"
    condition_B :q_cat18q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_cat19q, "count>0"
    condition_B :q_cat19q, "!=", :a_no
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_cat20q, "count>0"
    condition_B :q_cat20q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat121q, "count>0"
    condition_B :q_cat121q, "!=", :a_no
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat122q, "count>0"
    condition_B :q_cat122q, "!=", :a_no
    q_cat122c3 "Route:"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat122q, "count>0"
    ...
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat123qe, "count>0"
    condition_B :q_cat123qe, "!=", :a_no
    ...
    q_cat125q "24. Is Natural (no intervention) death required as an endpoint for this study?", :pick => :one
    a_yes "Yes"
    a_no "No"
    ...
    a :text
    dependency :rule=>"A and B"
    condition_A :q_cat125q, "count>0"
    condition_B :q_cat125q, "!=", :a_no
    q_cat125cc "c)List personnel responsible for animal observations"
    a :text
    dependency :rule=>"A and B"
    condition_A :q_cat125q, "count>0"
    condition_B :q_cat125q, "!=", :a_no
    q_cat125cd "d) How oftern will animals be monitored?"
    a :string
    dependency :rule=>"A and B"
    condition_A :q_cat125q, "count>0"
    condition_B :q_cat125q, "!=", :a_no
